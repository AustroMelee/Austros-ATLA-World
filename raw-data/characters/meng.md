...
## ⚙️ BACKEND METADATA (v3.0 EXPANSION) - MENG
...
```json
{
  "currentAffiliations": ["Aunt Wu's Fortune Salon", "Makapu Village"],
  "pastAffiliations": [],
  "allegianceHistory": [],
  "isRoyalty": false,
  "politicalPower": "none",
...
{
  "relationships": [
    { "characterId": "aunt-wu", "relationshipType": "mentor", "status": "positive", "history": "Aunt Wu's eager apprentice and assistant." },
    { "characterId": "aang", "relationshipType": "crush", "status": "neutral", "history": "Developed a crush on Aang, believing he was her destined love." },
    { "characterId": "katara", "relationshipType": "friend", "status": "positive", "history": "Supportive but a little jealous." },
    { "characterId": "team-avatar", "relationshipType": "allies", "status": "positive", "history": "Helped Team Avatar during their visit to Makapu Village." }
  ],
  "groupMemberships": [],
  "petCompanions": []
}
